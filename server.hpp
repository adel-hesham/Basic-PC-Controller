...
public:
    ...
    makesocket(int port, sa_family_t ipversion,int protocol);
    
    makesocket(int port, sa_family_t ipversion,int protocol,std::string address);
...
private:
    const int create_server_socket(sa_family_t &ipversion,int &protocol);
